...
function SchedulePage({ slStandings }) {
  ...
  let fixtures = useEspn ? espnFixtures.map((e) => {
    var _a, _b, _c, _d, _e, _f;
    return {
      id: e.id,
      t: "SL",
      home: ((_a = e.home) == null ? void 0 : _a.abbr) || ((_b = e.home) == null ? void 0 : _b.name) || "",
      away: ((_c = e.away) == null ? void 0 : _c.abbr) || ((_d = e.away) == null ? void 0 : _d.name) || "",
      kickoff: e.date,
      homeScore: (_e = e.home) == null ? void 0 : _e.score,
      awayScore: (_f = e.away) == null ? void 0 : _f.score,
      status: e.status,
      round: e.round,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "12px 16px 80px" }, children: [
    ...
    view === "list" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      fixtures.map((m2) => {
        ...
        const isPast = ko < now;
        const isSL = m2.t === "SL";
        const homeRank = rankMap[m2.home] || rankMap[(_a = TEAMS[m2.home]) == null ? void 0 : _a.name] || rankMap[(_b = TEAMS[m2.home]) == null ? void 0 : _b.abbr];
        const awayRank = rankMap[m2.away] || rankMap[(_c = TEAMS[m2.away]) == null ? void 0 : _c.name] || rankMap[(_d = TEAMS[m2.away]) == null ? void 0 : _d.abbr];
