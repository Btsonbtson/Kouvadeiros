...
function LeaguePage({ predictions, results, thavmaStats }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "16px 16px 80px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 6, marginBottom: 16, overflowX: "auto", scrollbarWidth: "none" }, children: [{ id: "standings", l: "Συγκομιδή" }, { id: "rivalry", l: "🌶️ Διαγκωνισμοί" }, { id: "analytics", l: "Αναλυτικά" }, { id: "campaigns", l: "Ενεργές Διοργανώσεις" }].map((tabItem) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setTab(tabItem.id), style: { fontSize: 11, fontWeight: 700, padding: "6px 13px", borderRadius: 7, border: `1px solid ${tab === tabItem.id ? "rgba(255,255,255,.3)" : LINE$1}`, background: tab === tabItem.id ? "rgba(255,255,255,.12)" : "transparent", color: tab === tabItem.id ? TEXT : MUTED$1, cursor: "pointer", whiteSpace: "nowrap", flexShrink: 0, letterSpacing: ".03em" }, children: tabItem.l }, tabItem.id)) }),
