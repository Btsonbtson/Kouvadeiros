...
function App({ user, onLogout }) {
  ...
  const pages = {
    matchday: /* @__PURE__ */ jsxRuntimeExports.jsx(MatchdayPage, { predictions: state.predictions, results: state.results, onRefresh: load, currentUser: user, revealed: state.revealed, onSave: savePrediction, liveScores }),
...
function LeaguePage({ predictions, results, thavmaStats }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "16px 16px 80px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 6, marginBottom: 16, overflowX: "auto", scrollbarWidth: "none" }, children: [{ id: "standings", l: "Συγκομιδή" }, { id: "rivalry", l: "🌶️ Διαγκωνισμοί" }, { id: "analytics", l: "Αναλυτικά" }, { id: "campaigns", l: "Ενεργές Διοργανώσεις" }].map((tabItem) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
    ...
    tab === "analytics" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: 24, textAlign: "center", color: MUTED$1, fontSize: 13 }, children: "Αναλυτικά σύντομα..." }),
    tab === "campaigns" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: 24, textAlign: "center", color: MUTED$1, fontSize: 13 }, children: "Ενεργές Διοργανώσεις σύντομα..." })
  ] });
}
...
function MatchPredictCard({ match, result, predictions, onRefresh, allResults, currentUser, revealed, onSave, liveScore }) {
  ...
  const ScoreRow = ({ lbl, hv, setHv, av, setAv, sm }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginBottom: sm ? 6 : 0 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "grid", gridTemplateColumns: "1fr auto 1fr", alignItems: "center", gap: 8 }, children: [["h", hv, setHv], ["a", av, setAv]].map(([side, v2, set], i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(React.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "14px 14px 12px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr auto 1fr", alignItems: "center", gap: 10, marginBottom: 8 }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", gap: 5 }, children: [
          ...
          (result == null ? void 0 : result.overtime) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 9, fontWeight: 700, color: GOLD, letterSpacing: ".03em", textAlign: "center" }, children: result.penalties ? `ΜΠΕΝΑΛΝΤΙΖ ${result.penH}–${result.penA}` : `ΠΑΡΑΤΑΣΗ ${result.otH}–${result.otA}` }),
      ...
      leg1Agg && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { fontSize: 13, fontWeight: 900, color: TEXT, fontVariantNumeric: "tabular-nums" }, children: [
            (_c = TEAMS[leg1Agg.leg1Fix.home]) == null ? void 0 : _c.abbr,
            " ",
            leg1Agg.h1,
            "–",
            leg1Agg.a1,
            " ",
            (_d = TEAMS[leg1Agg.leg1Fix.away]) == null ? void 0 : _d.abbr
          ] })
        ] }),
      ...
      !hasRes && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 12, borderTop: `1px solid ${LINE$1}`, paddingTop: 12 }, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", gap: 6 }, children: [match.home, match.away].map((tm) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: ((_a2 = TEAMS[tm]) == null ? void 0 : _a2.abbr) || tm
              },
              tm
            );
          }) })
        ...
        predOT && !locked && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 8 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreRow, { lbl: predPen ? "ΜΠΕΝΑΛΝΤΙΖ" : "ΠΑΡΑΤΑΣΗ", hv: otH, setHv: setOtH, av: otA, setAv: setOtA, sm: true }) }),
      ...
      !showAllPreds && locked && !hasRes && myPred && currentUser && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
        marginTop: 10,
        background: "rgba(255,255,255,.04)",
        border: `1px solid ${((_e = PC[currentUser.id]) == null ? void 0 : _e.b) || LINE$1}`,
        borderRadius: 9,
        padding: "8px 10px",
        display: "flex",
        alignItems: "center",
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React$1.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Root, {}) })
);
