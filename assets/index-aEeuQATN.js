...
function App({ user, onLogout }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    showAddPlayer && (user == null ? void 0 : user.role) === "admin" && /* @__PURE__ */ jsxRuntimeExports.jsx(AddPlayerModal, { onClose: () => setShowAddPlayer(false), onAdded: load }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "8px 16px 0", overflowX: "auto", scrollbarWidth: "none" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LeaderSidebar, { predictions: state.predictions, results: state.results, compact: true }) }),
