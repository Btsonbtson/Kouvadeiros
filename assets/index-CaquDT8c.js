...
function App({ user, onLogout }) {
  ...
  if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { minHeight: "100vh", minHeight: "100dvh", background: BG$1, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 16 }, children: [
  ...
  if (isDesktop) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", minHeight: "100vh", minHeight: "100dvh", background: BG$1, fontFamily: "'Space Grotesk',system-ui,sans-serif", color: TEXT }, children: [
...
function MatchPredictCard({ match, result, predictions, onRefresh, allResults, currentUser, revealed, onSave, liveScore, slStandings }) {
  ...
  const slHome = isSL ? (slStandings || []).find((t2) => {
    var _a2;
    return t2.team === match.home || t2.name === ((_a2 = TEAMS[match.home]) == null ? void 0 : _a2.name);
  }) : null;
  const slAway = isSL ? (slStandings || []).find((t2) => {
    var _a2;
    return t2.team === match.away || t2.name === ((_a2 = TEAMS[match.away]) == null ? void 0 : _a2.name);
  }) : null;
...
function SchedulePage({ slStandings }) {
  ...
  const [h2hMatch, setH2hMatch] = React.useState(null);
  const [nFilter, setNFilter] = React.useState("all");
  const now = Date.now();
  const formMap = {};
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "12px 16px 80px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 8, marginBottom: 14, flexWrap: "wrap", alignItems: "center" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "select",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "all", children: "Όλες οι ομάδες" }),
            allTeams.map((t2) => {
              var _a;
    ...
    view === "list" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      fixtures.map((m2) => {
        var _a, _b;
        const ko = new Date(m2.kickoff).getTime();
        const isPast = ko < now;
        const isSL = m2.t === "SL";
        const homeRank = rankMap[m2.home];
        const awayRank = rankMap[m2.away];
        const homeForm = formMap[m2.home] || [];
        const awayForm = formMap[m2.away] || [];
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          background: SURF$1,
          border: "1px solid " + LINE$1,
          borderRadius: 12,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 8 }, children: [
            ...
            isPast && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 9, color: MUTED$1, background: "rgba(255,255,255,.06)", borderRadius: 4, padding: "2px 5px" }, children: "✓ Παρελθόν" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr auto 1fr", alignItems: "center", gap: 8 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 4 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, fontWeight: 700, color: TEXT }, children: ((_a = TEAMS[m2.home]) == null ? void 0 : _a.name) || m2.home }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TeamLogo, { k: m2.home, size: 24 })
              ] }),
              isSL && homeForm.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", justifyContent: "flex-end" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FormStrip, { form: homeForm }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { textAlign: "center" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, fontWeight: 700, color: isPast ? TEXT : DIM }, children: "vs" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 4 }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TeamLogo, { k: m2.away, size: 24 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 12, fontWeight: 700, color: TEXT }, children: ((_b = TEAMS[m2.away]) == null ? void 0 : _b.name) || m2.away }),
              ...
              isSL && awayForm.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(FormStrip, { form: awayForm })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
      ...
      fixtures.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: 32, textAlign: "center", color: MUTED$1, fontSize: 13 }, children: "Δεν βρέθηκαν αγώνες" })
    ] }),
  ...
  render() {
    ...
    if (this.state.error) {
      return React$1.createElement(
        ...
        React$1.createElement("div", { style: { fontSize: 32 } }, "❌"),
        React$1.createElement("div", { style: { fontSize: 16, fontWeight: 700 } }, "ΚΟΥΒΑΔΕΪΡΟΣ — Crash"),
...
function Root() {
  ...
  if (!user) return React$1.createElement(Login, { onLogin: handleLogin });
  return React$1.createElement(App, { user, onLogout: handleLogout });
}
