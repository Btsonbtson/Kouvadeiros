...
function MatchdayPage({ predictions, results, onRefresh, currentUser, revealed, onSave, liveScores: liveScores2 }) {
  const now = Date.now();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { padding: "12px 16px 80px" }, children: [
    ...
    sorted.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      MatchPredictCard,
      {
        ...
        revealed,
        onSave,
        liveScore: liveScores2 == null ? void 0 : liveScores2[m2.id]
      },
      m2.id
    ))
  ] });
